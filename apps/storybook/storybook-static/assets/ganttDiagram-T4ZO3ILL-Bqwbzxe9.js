import {
  ...
  z as Zn,
  u as Bn,
} from './mermaid.core-ORyKTq4A.js';
import { c as re, g as ie } from './iframe-BMk1oW9O.js';
import { b as Xn, t as $e, c as qn, a as Gn, l as jn } from './linear-DfE894pO.js';
...
function rn(t, e) {
  ...
  function _(S) {
    var B = r ?? (e.ticks ? e.ticks.apply(e, n) : e.domain()),
      A = i ?? (e.tickFormat ? e.tickFormat.apply(e, n) : tr),
      U = Math.max(a, 0) + m,
      L = e.range(),
      N = +L[0] + F,
      W = +L[L.length - 1] + F,
      Z = (e.bandwidth ? ir : rr)(e.copy(), F),
    ...
    ((p = p.merge(
      ...
      (w = w.merge(
        h
          ...
          .attr(k, C * U)
          .attr('dy', t === Gt ? '0em' : t === pe ? '0.71em' : '0.32em'),
      )),
      S !== j &&
        ((p = p.transition(S)),
        (g = g.transition(S)),
      ...
      p.attr(
        ...
        t === qt || t === oe
          ? c
            ? 'M' + C * c + ',' + N + 'H' + F + 'V' + W + 'H' + C * c
            : 'M' + F + ',' + N + 'V' + W
          : c
            ? 'M' + N + ',' + C * c + 'V' + F + 'H' + W + 'V' + C * c
            : 'M' + N + ',' + F + 'H' + W,
      ),
      ...
      j
        ...
        .attr('text-anchor', t === oe ? 'start' : t === qt ? 'end' : 'middle'),
      j.each(function () {
        this.__axis = Z;
      }));
  }
...
function ln(t) {
  ...
  var e = fe(t.r),
    n = fe(t.g),
    r = fe(t.b),
    i = ce((0.2225045 * e + 0.7168786 * n + 0.0606169 * r) / an),
    a,
    c;
  return (
    e === n && n === r
      ? (a = c = i)
      : ((a = ce((0.4360747 * e + 0.3850649 * n + 0.1430804 * r) / sn)),
        (c = ce((0.0139322 * e + 0.0971045 * n + 0.7141733 * r) / on))),
...
function dr(t) {
  ...
  if ((t instanceof ft || (t = ln(t)), t.a === 0 && t.b === 0))
...
function hr(t) {
  return function (e, n) {
    var r = t((e = ve(e)).h, (n = ve(n)).h),
      i = ae(e.c, n.c),
      a = ae(e.l, n.l),
      c = ae(e.opacity, n.opacity);
    return function (m) {
...
function et(t, e, n, r) {
  ...
  return (
    ...
    (i.range = (a, c, m) => {
      ...
      let C;
      do (F.push((C = new Date(+a))), e(a, m), t(a));
      while (C < a && a < c);
      return F;
    }),
    (i.filter = (a) =>
    ...
    n &&
      ((i.count = (a, c) => (de.setTime(+a), he.setTime(+c), t(de), t(he), Math.floor(n(de, he)))),
      (i.every = (a) => (
        (a = Math.floor(a)),
        !isFinite(a) || !(a > 0)
          ? null
...
function Dr(t, e, n, r, i, a) {
  ...
  function m(C, k, E) {
    const _ = k < C;
    _ && ([C, k] = [k, C]);
    const S = E && typeof E.range == 'function' ? E : F(C, k, E),
      B = S ? S.range(C, +k + 1) : [];
    return _ ? B.reverse() : B;
  }
  function F(C, k, E) {
    const _ = Math.abs(k - C) / E,
      S = Xn(([, , U]) => U).right(c, _);
    ...
    return function (V) {
      ...
      if (
        ...
        ('W' in l || 'U' in l) &&
          ...
          (Q = 'Z' in l ? ye(At(l.y, 0, 1)).getUTCDay() : ge(At(l.y, 0, 1)).getDay()),
          (l.m = 0),
          (l.d =
  ...
  function y(M, H, V, l) {
    for (var J = 0, $ = H.length, Q = V.length, G, it; J < $; ) {
      ...
      if (((G = H.charCodeAt(J++)), G === 37)) {
        if (
          ((G = H.charAt(J++)), (it = j[G in Ne ? H.charAt(J++) : G]), !it || (l = it(M, V, l)) < 0)
        )
          return -1;
...
function Fi() {
  return Qn.apply(
    xn(Mr, Cr, kt, Pt, Vt, xt, Ht, Ot, vt, te).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]),
    arguments,
  );
}
var bn = { exports: {} };
        ...
        (m.isoWeek = function (C) {
          ...
          var k,
            ...
            A =
              ((k = this.isoWeekYear()),
              (E = this.$u),
              (_ = (E ? a.utc : a)().year(k).startOf('year')),
              (S = 4 - _.isoWeekday()),
              _.isoWeekday() > 4 && (S += 7),
              _.add(S, n));
...
(function (t, e) {
  (function (n, r) {
        ...
        Do: [
          ...
          function (U) {
            var L = F.ordinal,
              N = U.match(/\d+/);
            if (((this.day = N[0]), L))
              for (var W = 1; W <= 31; W += 1) L(W).replace(/\[|\]/g, '') === U && (this.day = W);
          },
        ],
        w: [c, k('week')],
        ww: [a, k('week')],
    ...
    function A(U) {
      ...
      ((L = U), (N = F && F.formats));
      for (
        var W = (U = L.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function (D, w, T) {
              ...
              try {
                ...
                return M
                  ...
                  : o
                    ...
                    : ((Q = new Date(J, $, l, G, it, at, pt)), H && (Q = q(Q).week(H).toDate()), Q);
              } catch {
                return new Date('');
              }
            })(p, h, g, N)),
        ...
        return (
          ...
          (g.parseFromMilliseconds = function () {
            ...
            ((this.$d.years = L(y / C)),
              ...
              (this.$d.hours = L(y / c)),
              (y %= c),
              (this.$d.minutes = L(y / a)),
              (y %= a),
              (this.$d.seconds = L(y / i)),
              (y %= i),
          ...
          (g.get = function (y) {
            var h = this.$ms,
              D = A(y);
            return (
              D === 'milliseconds' ? (h %= 1e3) : (h = D === 'weeks' ? L(h / _[D]) : this.$d[D]),
              h || 0
            );
          }),
...
var Te = (function () {
  var t = d(function (v, u, f, x) {
    ...
    D = {
      ...
      performAction: d(function (u, f, x, b, Y, o, q) {
        var s = o.length - 1;
        switch (Y) {
          case 1:
            return o[s - 1];
      ...
      parse: d(function (u) {
        ...
        function J() {
          ...
          return (
            (ot = b.pop() || O.lex() || P),
            typeof ot != 'number' &&
              (ot instanceof Array && ((b = ot), (ot = b.pop())), (ot = f.symbols_[ot] || ot)),
            ot
          );
        }
        d(J, 'lex');
          ...
          switch (G[0]) {
            ...
            case 2:
              if (
                ...
                (it = this.performAction.apply(at, [s, R, I, st.yy, G[1], Y, o].concat(K))),
                typeof it < 'u')
              )
                return it;
              (ut &&
                ...
                Y.push(at.$),
                o.push(at._$),
                (We = q[x[x.length - 2]][x[x.length - 1]]),
                x.push(We));
              break;
            case 3:
              return !0;
      ...
      var v = {
        ...
        unput: d(function (u) {
          ...
          return (
            ...
            this.options.ranges && (this.yylloc.range = [Y[0], Y[0] + this.yyleng - f]),
...
` +
        ...
        next: d(function () {
          ...
          for (var Y = this._currentRules(), o = 0; o < Y.length; o++)
            if (
              ((x = this._input.match(this.rules[Y[o]])), x && (!f || x[0].length > f[0].length))
            ) {
              if (((f = x), (b = o), this.options.backtrack_lexer)) {
                if (((u = this.test_match(x, Y[o])), u !== !1)) return u;
                if (this._backtrack) {
                  f = !1;
                  continue;
                } else return !1;
          ...
          return f
            ? ((u = this.test_match(f, Y[b])), u !== !1 ? u : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
` +
        ...
        performAction: d(function (f, x, b, Y) {
          switch (b) {
            case 0:
...
var je = { friday: 5, saturday: 6 },
  ...
  Sn = d(function (t, e, n, r) {
    const i = t.format(e.trim()),
      a = t.format('YYYY-MM-DD');
    return r.includes(i) || r.includes(a)
      ? !1
      : (n.includes('weekends') && (t.isoWeekday() === je[ne] || t.isoWeekday() === je[ne] + 1)) ||
  ...
  _n = d(function (t, e, n, r) {
    ...
    const [c, m] = hs(i, a, e, n, r);
    ((t.endTime = c.toDate()), (t.renderEndTime = m));
  }, 'checkTaskDates'),
  hs = d(function (t, e, n, r, i) {
    let a = !1,
      c = null;
    for (; t <= e; )
  ...
  ms = d(function (t, e) {
    ...
    return (
      a &&
        ((i.endTime = Fn(i.startTime, lt, a, Zt)),
  ...
  Qe = d(function () {
    const t = d(function (n) {
      ...
      return (
        tt[n].startTime &&
          ((tt[n].endTime = Fn(tt[n].startTime, lt, tt[n].raw.endTime.data, Zt)),
          tt[n].endTime &&
            ((tt[n].processed = !0),
...
var ws = d(function () {
  ...
  dt,
  ke = 1e4,
  Ms = d(function (t, e, n, r) {
    const i = Yt().gantt;
    r.db.setDiagramId(e);
    const a = Yt().securityLevel;
    let c;
    a === 'sandbox' && (c = Xt('#i' + e));
    const m = a === 'sandbox' ? Xt(c.nodes()[0].contentDocument.body) : Xt('body'),
      F = a === 'sandbox' ? c.nodes()[0].contentDocument : document,
      C = F.getElementById(e);
    ((dt = C.parentElement.offsetWidth),
      dt === void 0 && (dt = 1200),
      i.useWidth !== void 0 && (dt = i.useWidth));
    const k = r.db.getTasks();
    let E = [];
    for (const h of k) E.push(h.type);
    E = y(E);
    const _ = {};
    ...
    if (r.db.getDisplayMode() === 'compact' || i.displayMode === 'compact') {
      ...
      for (const h of E) _[h] = k.filter((D) => D.type === h).length;
    }
    ...
    function L(h, D, w) {
      const T = i.barHeight,
        ...
        u = i.topPadding,
        f = i.leftPadding,
        x = jn().domain([0, E.length]).range(['#00B9FA', '#F95002']).interpolate(mr);
      ...
      B.append('g')
        ...
        .attr('class', function (s) {
          for (const [I, R] of E.entries())
            if (s.type === R) return 'section section' + (I % i.numberSectionStyles);
          return 'section section0';
        })
        .enter();
      const Y = B.append('g').selectAll('rect').data(h).enter(),
        o = r.db.getLinks();
      if (
        (Y.append('rect')
          .attr('id', function (s) {
          ...
          .attr('class', function (s) {
            ...
            let z = 0;
            for (const [K, O] of E.entries()) s.type === O && (z = K % i.numberSectionStyles);
            let P = '';
            return (
              s.active
                ? s.crit
        ...
        Y.append('text')
          ...
          .attr('x', function (s) {
            ...
            if (
              (s.milestone && ((I += 0.5 * (A(s.endTime) - A(s.startTime)) - 0.5 * v), (R = I + v)),
              s.vert)
            )
          ...
          .attr('class', function (s) {
            ...
            let K = 0;
            for (const [st, M] of E.entries()) s.type === M && (K = st % i.numberSectionStyles);
            let O = '';
            return (
        ...
        Y.filter(function (R) {
          ...
          var z = I.querySelector('#' + CSS.escape(e + '-' + R.id)),
            P = I.querySelector('#' + CSS.escape(e + '-' + R.id + '-text'));
    ...
    function W(h, D, w, T, v, u, f, x) {
      ...
      B.append('g')
        ...
        .enter()
        .append('rect')
        .attr('id', (z) => e + '-exclude-' + z.start.format('YYYY-MM-DD'))
    ...
    function j(h, D, w, T) {
      ...
      if (Y !== null) {
        ...
        if (isNaN(o) || o <= 0)
          Tt.warn(`Invalid tick interval value: "${Y[1]}". Skipping custom tick interval.`);
        else {
          const q = Y[2],
      ...
      B.append('g')
        ...
        .append(function (v) {
          const u = v[0].split(zn.lineBreakRegex),
            f = -(u.length - 1) / 2,
            x = F.createElementNS('http://www.w3.org/2000/svg', 'text');
...
`,
  ...
  _s = Ss,
  As = { parser: Hi, db: bs, renderer: Cs, styles: _s };
