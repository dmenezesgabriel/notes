      ...
      parse: o(function (t) {
        ...
        function j() {
          ...
          return (
            (P = u.pop() || b.lex() || E),
            typeof P != 'number' &&
              (P instanceof Array && ((u = P), (P = u.pop())), (P = s.symbols_[P] || P)),
            P
          );
        }
        o(j, 'lex');
        for (var A, W, B, K, H = {}, X, V, et, Y; ; ) {
          if (
            ...
            this.defaultActions[W]
              ...
              : ((A === null || typeof A > 'u') && (A = j()), (B = v[W] && v[W][A])),
...
var xt = tt,
  ...
  It = o((e, h, r, a) => {
    ...
    const f = ot(),
      ...
      N = ((z = f.ishikawa) == null ? void 0 : z.useMaxWidth) ?? !1,
      O = dt(h),
    ...
    for (let T = 0; T < b; T++) {
      ...
      for (const [F, j, A] of [
        ...
        F && Pt(D, F, i, u, j, A, k, t);
      i = D.selectAll('text')
        .nodes()
        .reduce((F, j) => Math.min(F, j.getBBox().x), 1 / 0);
    }
