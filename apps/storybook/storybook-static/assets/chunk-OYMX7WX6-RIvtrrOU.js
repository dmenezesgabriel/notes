import { g as te } from './chunk-55IACEB6-gztn98QH.js';
import { s as ee } from './chunk-EDXVE4YY-CXXKLgPc.js';
import {
  _ as f,
  l as b,
  c as F,
      ...
      parse: f(function (l) {
        ...
        function Lt() {
          ...
          return (
            (R = g.pop() || k.lex() || tt),
            typeof R != 'number' &&
              (R instanceof Array && ((g = R), (R = g.pop())), (R = h.symbols_[R] || R)),
            R
          );
        }
        f(Lt, 'lex');
  ...
  Ne = f(async function (t, e, s, a) {
    ...
    try {
      (typeof a.db.getLinks == 'function' ? a.db.getLinks() : new Map()).forEach((L, v) => {
        ...
        (d.replaceChild(D, C),
          D.appendChild(C),
          b.info('🔗 Wrapped node in <a> tag for:', O, L.url));
      });
    } catch (m) {
