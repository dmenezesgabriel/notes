...
import { l as zt } from './linear-DfE894pO.js';
  ...
  var e = a(function (F, h, c, g) {
    ...
    V = {
      ...
      parse: a(function (h) {
        ...
        a(Vt, 'lex');
        for (var I, q, z, mt, G = {}, ut, N, Bt, gt; ; ) {
          if (
            ((q = g[g.length - 1]),
            this.defaultActions[q]
              ? (z = this.defaultActions[q])
              : ((I === null || typeof I > 'u') && (I = Vt()), (z = rt[q] && rt[q][I])),
...
Expecting ` +
              ...
              : (yt =
                  ...
                  (ct + 1) +
                  ': Unexpected ' +
                  (I == It ? 'end of input' : "'" + (this.terminals_[I] || I) + "'")),
              this.parseError(yt, {
                text: D.match,
          ...
          if (z[0] instanceof Array && z.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + q + ', token: ' + I,
            );
          switch (z[0]) {
            case 1:
              (g.push(I),
            ...
            case 2:
              if (
                ...
                (mt = this.performAction.apply(G, [d, Mt, ct, $.yy, z[1], C, r].concat(li))),
                typeof mt < 'u')
              )
                return mt;
              (N &&
                ((g = g.slice(0, -1 * N * 2)), (C = C.slice(0, -1 * N)), (r = r.slice(0, -1 * N))),
...
` +
        ...
        next: a(function () {
          ...
          for (var C = this._currentRules(), r = 0; r < C.length; r++)
            if (
              ((g = this._input.match(this.rules[C[r]])), g && (!c || g[0].length > c[0].length))
            ) {
...
var Q,
  Ht =
    ((Q = class {
      ...
      getMaxDimension(t, i) {
        if (!this.parentGroup)
          return { width: t.reduce((o, u) => Math.max(u.length, o), 0) * i, height: i };
