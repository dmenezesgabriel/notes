...
import { g as Ne } from './chunk-FMBD7UC4-tS6AgrCp.js';
...
` + t,
    ...
    for (const y of w) {
      ...
      ((x = Math.max(x, (U = _ == null ? void 0 : _.labelBBox) == null ? void 0 : U.height)),
        j.push(_));
    }
    let P = 0;
    for (const y of w) {
...
`,
  ...
  Me = je,
  Xe = { db: Ve, renderer: Ge, parser: xe, styles: Me };
