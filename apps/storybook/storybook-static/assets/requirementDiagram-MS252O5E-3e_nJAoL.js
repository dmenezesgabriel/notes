import { g as Ge } from './chunk-55IACEB6-gztn98QH.js';
import { s as Xe } from './chunk-EDXVE4YY-CXXKLgPc.js';
import {
  _ as d,
  D as Be,
  b as Je,
        ...
        for (var I, G, q, Te, J = {}, ye, F, Ye, _e; ; ) {
          if (
            ...
            this.defaultActions[G]
              ...
              : ((I === null || typeof I > 'u') && (I = Ue()), (q = de[G] && de[G][I])),
...
Expecting ` +
          ...
          if (q[0] instanceof Array && q.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + G + ', token: ' + I,
            );
          switch (q[0]) {
            case 1:
              (l.push(I),
            ...
            case 2:
              if (
                ...
                (Te = this.performAction.apply(J, [a, $e, ge, z.yy, q[1], R, t].concat(We))),
                typeof Te < 'u')
              )
                return Te;
              (F &&
