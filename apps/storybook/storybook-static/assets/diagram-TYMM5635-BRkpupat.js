...
import { p as _ } from './chunk-4BX2VUAB-DNt9yf9l.js';
import { p as L } from './wardley-RL74JXVD-DbzsJyh7.js';
...
var N = E.packet,
  ...
  Y = b((e, t) => {
    ...
    for (let { start: a, end: i, bits: d, label: c } of e.blocks) {
      ...
      if ((a ?? (a = o + 1), a !== o + 1))
        throw new Error(
          `Packet block ${a} - ${i ?? a} is not contiguous. It should start from ${o + 1}.`,
        );
      ...
      for (
        i ?? (i = a + (d ?? 1) - 1),
          d ?? (d = i - a + 1),
          o = i,
          w.debug(`Packet block ${a} - ${o} with label ${c}`);
