  ...
  [2799],
  {
    21829: (e, t, n) => {
      ...
      var i = n(18697),
        ...
        o = (0, i.K2)((e, t) => {
          let n;
          return (
            'sandbox' === t && (n = (0, s.Ltv)('#i' + e)),
            ('sandbox' === t
              ? (0, s.Ltv)(n.nodes()[0].contentDocument.body)
              : (0, s.Ltv)('body')
            ).select(`[id="${e}"]`)
          );
        }, 'getDiagramElement');
    ...
    28521: (e, t, n) => {
      ...
      var i = n(6639),
        ...
        o = (0, s.K2)((e, t, n, o) => {
          e.attr('class', n);
          let { width: c, height: l, x: h, y: d } = r(e, t);
          (0, i.a$)(e, l, c, o);
          let g = a(h, d, c, l, t);
          (e.attr('viewBox', g), s.Rm.debug(`viewBox configured: ${g} with padding: ${t}`));
        }, 'setupViewPortForSVG'),
        r = (0, s.K2)((e, t) => {
          let n = e.node()?.getBBox() || { width: 0, height: 0, x: 0, y: 0 };
          return { width: n.width + 2 * t, height: n.height + 2 * t, x: n.x, y: n.y };
        }, 'calculateDimensionsWithPadding'),
        a = (0, s.K2)((e, t, n, i, s) => `${e - s} ${t - s} ${n} ${i}`, 'createViewBox');
    },
    62799: (e, t, n) => {
      let i;
      n.d(t, { diagram: () => S });
      var s = n(21829),
        o = n(28521),
        r = n(64928);
      (n(97301), n(64146), n(1168), n(63687), n(85286), n(15968), n(61510));
      var a = n(6639),
        c = n(18697);
      let l = {
          randomUUID:
        ...
        m = (function () {
          var e = (0, c.K2)(function (e, t, n, i) {
            ...
            _ = {
              ...
              performAction: (0, c.K2)(function (e, t, n, i, s, o, r) {
                var a = o.length - 1;
                switch (s) {
                  case 6:
                  case 7:
              ...
              table: [
                ...
                { 6: n, 9: 22, 12: 11, 13: i, 14: 14, 15: s, 16: o, 17: 17, 18: 18, 19: r, 22: a },
                { 6: h, 7: d, 10: 23, 11: g },
                e(u, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: r, 22: a }),
                e(u, [2, 18]),
                e(u, [2, 19]),
                e(u, [2, 20]),
                e(u, [2, 21]),
              ...
              parse: (0, c.K2)(function (e) {
                ...
                ('function' == typeof p.parseError
                  ...
                  (0, c.K2)(_, 'lex'));
                for (var b, E, k, S, N, x, L, D, $, I = {}; ; ) {
                  if (
                    ((k = n[n.length - 1]),
                    this.defaultActions[k]
                      ? (S = this.defaultActions[k])
                      : (null == b && (b = _()), (S = r[k] && r[k][b])),
                    void 0 === S || !S.length || !S[0])
                  ) {
                    var v = '';
                    for (x in (($ = []), r[k]))
                      this.terminals_[x] && x > 2 && $.push("'" + this.terminals_[x] + "'");
                    ((v = u.showPosition
                      ? 'Parse error on line ' +
                        (l + 1) +
                        ':\n' +
                  ...
                  switch (S[0]) {
                    ...
                    case 2:
                      if (
                        ...
                        void 0 !==
                          (N = this.performAction.apply(I, [a, h, l, p, S[1], s, o].concat(g))))
                      )
                        return N;
                      (L &&
                        ((n = n.slice(0, -1 * L * 2)),
          ...
          return (
            (_.lexer = {
              ...
              performAction: (0, c.K2)(function (e, t, n, i) {
                switch (n) {
                  case 0:
      ...
      var f = {
        ...
        _ = class {
          ...
          getType(e, t) {
            switch ((c.Rm.debug('In get type', e, t), e)) {
              case '[':
          ...
          decorateNode(e) {
            ...
            (e.icon && (n.icon = (0, a.jZ)(e.icon, t)),
              e.class && (n.class = (0, a.jZ)(e.class, t)));
          }
          type2Str(e) {
            switch (e) {
          ...
          flattenNodes(e, t) {
            ...
            if ((t.push(r), e.children)) for (let n of e.children) this.flattenNodes(n, t);
          }
          generateEdges(e, t) {
          ...
          getData() {
            let e = this.getMindmap(),
              t = (0, a.D7)();
            if ((void 0 !== (0, a.TM)().layout || (t.layout = 'cose-bilkent'), !e))
              return { nodes: [], edges: [], config: t };
            (c.Rm.debug('getData: mindmapRoot', e, t), this.assignSections(e));
            let n = [],
              i = [];
            (this.flattenNodes(e, n),
              this.generateEdges(e, i),
              c.Rm.debug(`getData: processed ${n.length} nodes and ${i.length} edges`));
            let s = new Map();
            for (let e of n)
              s.set(e.id, { shape: e.shape, width: e.width, height: e.height, padding: e.padding });
            return {
              nodes: n,
              edges: i,
              config: t,
        ...
        b = (0, c.K2)(async (e, t, n, i) => {
          c.Rm.debug('Rendering mindmap diagram\n' + e);
          let l = i.db,
            h = l.getData(),
            d = (0, s.A)(t, h.config.securityLevel);
          if (
            ((h.type = i.type),
            (h.layoutAlgorithm = (0, r.q7)(h.config.layout, { fallback: 'cose-bilkent' })),
            (h.diagramId = t),
            !l.getMindmap())
          )
            return;
          ...
          (0, o.P)(
            d,
            h.config.mindmap?.padding ?? a.UI.mindmap.padding,
            'mindmapDiagram',
            h.config.mindmap?.useMaxWidth ?? a.UI.mindmap.useMaxWidth,
          );
        }, 'draw'),
        E = (0, c.K2)((e) => {
          ...
          for (let t = 0; t < e.THEME_COLOR_LIMIT; t++)
            ((e['lineColor' + t] = e['lineColor' + t] || e['cScaleInv' + t]),
              (0, u.A)(e['lineColor' + t])
                ? (e['lineColor' + t] = (0, p.A)(e['lineColor' + t], 20))
                : (e['lineColor' + t] = (0, y.A)(e['lineColor' + t], 20)));
