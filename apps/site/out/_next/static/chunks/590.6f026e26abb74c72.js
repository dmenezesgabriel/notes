                  ...
                  if (r === o)
                    ...
                    if (
                      ...
                      -I === D
                        ...
                        : I === D &&
                          (o > r ? ((i[2] = f), (i[3] = y)) : ((i[2] = N), (i[3] = A)), (m = !0)),
                      L && m)
                    )
                      return !1;
                    if (
    ...
    90590: (t, e, i) => {
      ...
      function l(t) {
        return new Promise((e) => {
          let i = (0, s.Ltv)('body').append('div').attr('id', 'cy').attr('style', 'display:none'),
            o = (0, n.A)({
      ...
      async function c(t, e) {
        ...
        try {
          ...
          let e = await l(t),
            ...
            n = u(e);
          return (
            r.Rm.debug(`Layout completed: ${i.length} nodes, ${n.length} edges`),
            { nodes: i, edges: n }
          );
        } catch (t) {
          throw (r.Rm.error('Error in cose-bilkent layout algorithm:', t), t);
        }
      }
      function d(t) {
            ...
            function (t, e, i) {
              ...
              ((v.prototype.newGraphManager = function () {
                ...
                (v.branchRadialLayout = function (t, e, i, r, n, o) {
                  ...
                  for (var N = Math.abs(r - i) / c, T = s; d != c; T = ++T % p) {
                    var _ = u[T].getOtherEnd(t);
                    if (_ != e) {
                      var L = (i + d * N) % 360,
                        m = (L + N) % 360;
